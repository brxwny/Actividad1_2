...
public class AddGasto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AddGasto.this, R.layout.spinner_personalizado,paths);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View v, int position, long id) {
                switch (position) {
                    case 0:
                        Toast.makeText(AddGasto.this, "Ninguna elegida", Toast.LENGTH_LONG).show();
                        break;
                    case 1:
                        Toast.makeText(AddGasto.this, "Cat 1 elegida", Toast.LENGTH_LONG).show();
                        break;
                    case 2:
                        Toast.makeText(AddGasto.this, "Cat 2 elegida", Toast.LENGTH_LONG).show();
                        break;
                    case 3:
                        Toast.makeText(AddGasto.this, "Cat 3 elegida", Toast.LENGTH_LONG).show();
                        break;
                }
            }
            @Override
